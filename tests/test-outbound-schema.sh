...
b.WLOC_STATE = os.path.join(work, "wloc.json")
b.ADBLOCK_STATE = os.path.join(work, "adblock.json")
b.ADBLOCK_RULES = os.path.join(work, "adblock-rules.json")
b.ADBLOCK_SOURCES = os.path.join(work, "adblock-sources.json")
os.makedirs(work, exist_ok=True)
json.dump(state, open(b.STATE, "w"), ensure_ascii=False)
json.dump({"enabled": False}, open(b.WLOC_STATE, "w"))
json.dump({"enabled": False}, open(b.ADBLOCK_STATE, "w"))
json.dump({"hosts": [], "rules": []}, open(b.ADBLOCK_RULES, "w"))
json.dump({"sources": [], "domain_sources": []}, open(b.ADBLOCK_SOURCES, "w"))
b._write(b.load())
